...
class Game:
    ...
    def check_lost(self):
        ...
        return self.game_active, canvas
    ...
    def recv_frame(self, frame, win):
        # Update frame count
        self.frame_count = self.frame_count + 1

        # Change light if conditions are met
        self.change_light()
        ...
        # Game end conditions
        game_active, canvas = self.check_lost()
        if not game_active:
            print("lost")
            return game_active, canvas
        elif win:
            print("won")
...
def main():
    ...
    while cap.isOpened() and game_active:
        ...
        if not ret:
            break
        game_active, new_frame = mygame.recv_frame(frame, is_win)
