...
class Game:
    ...
    def __init__(self):
        ...
        self.light_duration = random.randint(2, 6)
    ...
    def send_frame(self, frame):
        ...
        if (self.frame_count > 5 and not self.any_active_players()):
...
def main():
    ...
    mygame = Game()
    while cap.isOpened() and mygame.game_status:
        ret, frame = cap.read()
        if not ret:
            break
        frame = mygame.send_frame(frame)
